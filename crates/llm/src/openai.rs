...
mod tests {
    ...
    async fn capture_server_with(
        ...
        // reqwest is built with `rustls-no-provider`; constructing any
        // client panics without an installed crypto provider.
        crate::provider::install_rustls_crypto_provider();
